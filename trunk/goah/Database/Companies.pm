...
goah::Database::Companies->columns(All => qw/id vat_id name custtype payment_condition delay_interest reclamation_time www bank_accounts isowner description hidden firstname/);  
