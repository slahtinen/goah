...
__PACKAGE__->columns(All => qw/id companyid locationid billingid created updated ordernum state info ownerid lasttrigger dayinmonth repeat nexttrigger longinfo/);  
